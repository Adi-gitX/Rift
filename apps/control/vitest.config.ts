    ...
    poolOptions: {
      workers: {
        ...
        miniflare: {
          ...
          kvNamespaces: ['CACHE', 'ROUTES'],
          r2Buckets: ['TEMPLATES', 'BUNDLES', 'LOGS'],
          queueProducers: { EVENTS: 'raft-events' },
          queueConsumers: { 'raft-events': { maxBatchSize: 10, maxBatchTimeout: 1 } },
          durableObjects: {
          ...
          bindings: {
            ...
            CF_DEMO_API_TOKEN: 'test-cf-token',
          },
        },
      },
    },
